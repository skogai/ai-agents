...
version: 1.0.0
description: Stage-1 gating axis. Checks whether the PR diff satisfies the acceptance criteria of its linked REQ, DESIGN, or TASK docs before quality axes run
---
